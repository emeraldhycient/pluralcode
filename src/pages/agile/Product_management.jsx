...
import Hero from "../../components/agile/product_management/Hero";
import Videobg from "../../components/agile/product_management/Videobg";
import YouWillLearn from "../../components/agile/product_management/YouWillLearn";

function Agile_Product_management() {
  ...
  useEffect(() => {
    document.title = "Agile Product Management";
  }, []);
...
export default  Agile_Product_management
;
