...
function Faq({ faqs, setfaqs }) {
  ...
  return (
    <div className="w-full md:w-10/12 mx-auto py-28" id="faq">
      ...
      <div className=" rounded-lg p-4">
        {faqs?.map((faq, index) => (
          <div key={index} className="border rounded-lg mb-4">
            <div
              className={`shadow rounded p-4 font-bold text-slate-800 flex  items-center justify-between ${faq.isActive ? "bg-gray-100" : "bg-white"
                }`}
