...
function Courses() {
  const [courses, setCourses] = useState([
    ...
    {
      image: "https://i.im.ge/2022/12/14/dEwgN9.Vector.png",
      title: "Agile Product Management",
      description: `Master Agile in Product Management in just 12-week then become a Pro.Learn and understand the principles of product management.`,
      link: "/schools/cloud/Agile-Product-Management",
      level: "",
      mode: "",
      duration: "12 weeks",
      start_date: "01/01/2020",
