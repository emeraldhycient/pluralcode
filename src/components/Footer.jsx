...
function Footer() {
  return (
    <section className="bg-gray-100 h-[60vh] w-full p-16">
      <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
        ...
        <div className="col-span-1 md:col-span-4 w-full flex justify-evenly">
          <div className="">
            <h1 className="text-base text-gray-700 mb-4"> Courses </h1>
            <ul>
              <li className="text-xs text-gray-600 mb-2">Product Design</li>
              <li className="text-xs text-gray-600 mb-2">Product Management</li>
          ...
          <div className="">
            ...
            <ul>
              <li className="text-xs text-gray-600 mb-2">Pluralcode SandBox</li>
          ...
          <div className="">
            ...
            <ul>
              ...
              <li className="text-xs text-gray-600 mb-2">Hire Our Talents </li>
            </ul>
          </div>{" "}
          <div className="">
