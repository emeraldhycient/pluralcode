    ...
    <section className=" py-10 lg:py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 w-11/12 md:w-9/12 lg:w-8/12 mx-auto h-full w-full">
        ...
        <div className="flex justify-center items-center flex-col">
          <h1
            className="text-2xl md:text-3xl font-bold  font-gilroy md:text-center lg:text-left  w-full align-left text-[#222057] mb-4 lg:leading-tight	"
            data-aos="fade-right"
            data-aos-duration="2000"
          >
          ...
          <p
            className="font-gilroyregular text-[16px] md:text-center lg:text-left  font-extralight text-[#232323] mb-4"
            data-aos="fade-left"
            data-aos-duration="2000"
          >
