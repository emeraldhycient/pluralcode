...
import { Spinner, Modal, TextInput, Button, Label } from "flowbite-react";
  ...
  return (
    <React.Fragment>
      ...
      <button
        ...
        className="bg-amber-500 text-[12px] text-white px-8 py-2 rounded w-[80%] md:w-[50%]  mx-auto  flex justify-center items-center"
      >
        <a className="flex items-center">Start Learning</a>
      </button>
