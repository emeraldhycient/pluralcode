...
function Hero() {
  ...
  const handleSubmit = async (e) => {
    ...
    formdata.append("course", "Data Engineering");
    ...
    <section className="h-fit md:h-[60vh] lg:h-[90vh]   bg-[#F8F8FA] py-12">
      ...
      >
        ...
        <p className="font-gilroyregular text-[16px] text-center   font-extralight text-[#232323] mb-4">
          ...
          tools and techniques in Data Engineering Courses.
        </p>
        <h4 className="mb-4">Duration: 21 Weeks | Beginner Level</h4>
        {/* <h4 className="mb-4">Tuition Starting From: 380,000 </h4> */}
        <Link to="/tuition-fees" className="mb-4 text-amber-500">
          Check our Tuition Page
        </Link>
