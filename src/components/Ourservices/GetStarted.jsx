  ...
  return (
    <React.Fragment>
      ...
      >
        <Modal.Header />
        <Modal.Body>
          <div className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8 lg:pt-56">
            <h3 className="text-xl font-medium text-gray-900 dark:text-white">
              Tell us more about your company
            </h3>
            <p className="font-gilroyregular  text-sm">
              Kindly fill the form below with your appropriate details so we
              forward the brochure to you.
            </p>
