  ...
  const [courses3, setcourses3] = useState([
    {
      image: data2,
      title: "Data Science",
      content: `Learn Python-Based Data Science and Machine Learning.`,
      link: "https://wa.me/2348131529862?text=I'm%20interested%20in%20your%20Data%20Science%20Course",
    },
    {
      image: data3,
      title: "Data Engineering ",
      content: `Become a Data Engineer after taking our 20-week hands-on program.`,
  ...
  return (
    <section className="h-fit py-12 lg:py-36 w-screen bg-gray-50" id="schools">
      <center data-aos="zoom-in-up" data-aos-duration="1200">
        <h1 className="text-3xl md:text-4xl font-medium text-[#222057] font-gilroy text-center w-full align-left mb-5 md:mb-7 leading-snug	">
          Certificate Courses
        </h1>
        <p className="font-gilroyregular text-[14px] font-extralight mb-16 w-[90%] md:w-[43%] mx-auto text-center">
          Choose the Certificate Course you would like to learn and click the link underneath to chat with the Student Advisor and begin your enrollment        </p>
      </center>
