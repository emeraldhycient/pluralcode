...
function Certification() {
    return (
        <div className='h-fit md:h-[250px] bg-[#222057] w-full rounded-[24px] w-[90%] mx-auto flex flex-col md:flex-row justify-between items-center px-6 md:px-10 py-10 md:py-3 shadow-[0px 0px 42px rgba(0, 0, 0, 0.32]'>
            <div className="w-full md:w-[50%]">
                <h1 className="text-2xl font-medium text-white font-gilroy   mb-6 md:mb-10 leading-snug	">
