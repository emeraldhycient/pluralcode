...
function TrainingCard({ approach }) {
  ...
  return (
    <div
      className="bg-white shadow shadow-[0px -7.42184px 16.7347px -1.85539px rgba(16, 24, 40, 0.05), 0px 2.96863px 67.7755px -2.22647px rgba(16, 24, 40, 0.05)]  rounded-lg  pt-4 pl-4 pb-4 h-44"
      data-aos="fade-right"
